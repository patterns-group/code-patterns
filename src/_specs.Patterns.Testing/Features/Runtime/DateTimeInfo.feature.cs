...
namespace _specs.Patterns.Testing.Features.Runtime
{
...
#line 8
 testRunner.Given("I have a DateTime info provider for testing");
#line 9
 testRunner.And("I have configured the test DateTime info provider to use a static time");
#line 10
 testRunner.When("I store the return value of the DateTime info provider\'s \"GetNow\" method");
#line 11
 testRunner.Then("the stored DateTime value should be equal to the static time I used");
#line hidden
