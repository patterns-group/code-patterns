...
#line 17
 testRunner.Then("I should get an exception with message \"Input stream is not at beginning and cann" +
                    "ot seek. Conversion will lose data\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 23
 testRunner.Then("I should get empty result", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
