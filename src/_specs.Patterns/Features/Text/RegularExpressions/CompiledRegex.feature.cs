...
#line 6
 testRunner.Given("I have created a CompiledRegex using a simple, valid pattern string");
#line 7
 testRunner.When("I read the options of the CompiledRegex");
#line 8
 testRunner.Then("the options should include the compiled option");
#line hidden
...
this.ScenarioSetup(scenarioInfo);
#line 11
 testRunner.Given("I have a set of strings with various character patterns");
#line 12
...
#line 13
 testRunner.When("I use the CompiledRegex.Build method to create a CompiledRegex using the sample s" +
                    "tring");
#line 14
 testRunner.And("I use the CompiledRegex against each string in the set");
#line 15
...
this.ScenarioSetup(scenarioInfo);
#line 18
 testRunner.Given("I have created a CompiledRegex using a valid pattern string");
#line 19
 testRunner.When("I read the pattern string from the CompiledRegex");
#line 20
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Dictionary Match", exampleTags);
#line 22
this.ScenarioSetup(scenarioInfo);
#line 23
 testRunner.Given(string.Format("I have created a string equal to: {0}", input));
#line 24
 testRunner.And(string.Format("I have created a CompiledRegex with the pattern: {0}", pattern));
#line 25
 testRunner.When("I retrieve a dictionary match of the string using the CompiledRegex");
#line 26
 testRunner.Then(string.Format("all expected group values ({0}) should be found in the resulting dictionary", expectedGroupValues));
#line hidden
            this.ScenarioCleanup();
        }
    }
