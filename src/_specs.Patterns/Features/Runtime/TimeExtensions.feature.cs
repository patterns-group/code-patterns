...
#line 7
 testRunner.Given("I have a primary DateTime value");
#line 8
 testRunner.And("I have a secondary DateTime value");
#line 9
 testRunner.And("the DateTime values vary by millisecond");
#line 10
 testRunner.When("I adjust the accuracy of each DateTime value to one second");
#line 11
 testRunner.And("I compare the DateTime values");
#line 12
 testRunner.Then("the resulting difference should be zero");
#line hidden
